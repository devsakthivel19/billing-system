"""Production-minded settings for the Billing System project."""
...
def env_bool(name: str, default: bool = False) -> bool:
    ...
    Args:
        ...
        default: Value used when the variable is not defined.
...
def env_list(name: str, default: str = "") -> list[str]:
    ...
    Args:
        name: Environment variable name.
        default: Fallback comma-separated value.
...
if DATABASE_ENGINE == "postgres":
    DATABASES = {
        "default": {
            ...
            "NAME": os.getenv("POSTGRES_DB", "billing_system"),
            "USER": os.getenv("POSTGRES_USER", "billing_user"),
            "PASSWORD": os.getenv("POSTGRES_PASSWORD", "billing_password"),
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "billing@example.com")
